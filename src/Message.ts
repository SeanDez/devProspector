...
export default class Message {
  ...
  public recruiterColdOpen(firstName: string, intro: string): string {
    return `Hi ${firstName},
...
I was wondering if I could demonstrate my technical expertise via a coding challenge, or hop on a phone call to see if I was a good fit for a full stack developer role?`
  ...
  public engineerColdOpen(firstName: string, introCompliment?: string, companyName?: string): string {
    return `Hi ${firstName},
...
Would you be able to pass me through your network to a higher-up, or possibly a recruiter who could consider me?`;
  ...
  public salesmanColdOpen(firstName: string, introCompliment?: string, companyName?: string): string {
